...
int curser_row=2,curser_column=1,file_num=2,total_files,level=0,search_flag=0,total_rows,total_columns,listend;
string dst_root;
...
int main()
{
   ...
   // path=".";
    ...
    cout<<"rows:"<<total_rows<<" col:"<<total_columns<<flush;
  while(1)
  {
    char buffer[128];
    read(0,buffer,128);
